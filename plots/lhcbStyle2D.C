...
///////////////////////////////////////////////////////////////////
  ...
  //lhcbStyle->SetPalette(71);
  lhcbStyle->SetPalette(56);
  ...
  lhcbStyle->SetPadTopMargin(0.08);    //Abhijit
  lhcbStyle->SetPadLeftMargin(0.16);  //Abhijit
  //lhcbStyle->SetPadRightMargin(0.195); //Abhijit
  //lhcbStyle->SetPadRightMargin(0.17); //Abhijit
  lhcbStyle->SetPadRightMargin(0.21); //Abhijit
  ...
  lhcbStyle->SetLabelOffset(0.010,"Z"); //Abhijit
  ...
  lhcbStyle->SetTitleOffset(0.99,"Z"); //Abhijit
