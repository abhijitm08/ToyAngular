...
if __name__ == '__main__':
    ...
    #optional arguments
    parser.add_argument('-b', '--bscheme'   , dest='bscheme',type=str, default='Scheme2',help='(string) Binning scheme to be used. Available options are [Scheme0,Scheme1,Scheme2,Scheme3,Scheme4,Scheme5,Scheme6] and default is Scheme2 (5 x 5). See BinningSchemes/Binning_Scheme.py.')
